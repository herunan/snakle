...
export const Board: React.FC<BoardProps> = ({ snake, fruit, walls, kiwi }) => {
    ...
    return (
        ...
        >
            {cells.map((cell) => {
                ...
                const isKiwi = kiwi?.x === cell.x && kiwi?.y === cell.y;
                    ...
                    <div
                        ...
                        className={clsx(
                            'w-full h-full rounded-sm transition-all duration-100',
                            {
                                ...
                                'bg-yellow-400 rounded-full scale-90 shadow-[0_0_10px_rgba(250,204,21,0.5)] animate-pulse': isKiwi,
